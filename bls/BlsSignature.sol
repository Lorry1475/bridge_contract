...
contract BlsSignature is BlsSignatureVerification {
    bool public verified;
    bytes32 public  aggregatedPublicKey;

    function remakeAggregatedPublicKey(bytes32  _newKey) public{
      aggregatedPublicKey =  _newKey;
    }
    ...
    function verifyMultisignature(
       ...
       return verifyMultisig(aPub, pPub, _message, pSig, _signersBitmask);
    }
